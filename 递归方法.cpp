// A recursive program to test whether a given string can be segmented into space separated words in dictionary 
#include <iostream> 
using namespace std;
...
bool wordBreak(string str)
{
    ...
    {
        /*The parameter for dictionaryContains is str.substr(0, i) which is prefix (of input  
